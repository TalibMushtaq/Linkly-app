...
import { userSignup, userSignin, type UserSignupInputs, type UserSigninInputs } from '../middleware/user.schema';
...
router.post('/signup', async(req: Request<{}, {}, UserSignupInputs>, res: Response) => {
  try {
...
router.post('/signin', async(req: Request<{}, {}, UserSigninInputs>, res: Response) => {
  try {
